...
py::error_already_set BTrait::trait_erorr(py::error_already_set &exc, BTraitable *obj, const py::object& method, const py::object* value, const py::args* args) {
...
py::object BTrait::wrapper_f_get(BTraitable* obj) {
    try {
        ...
        throw trait_erorr(exc, obj, f_get, nullptr, nullptr);
    }
}
...
py::object BTrait::wrapper_f_get(BTraitable* obj, const py::args& args) {
    try {
        ...
        throw trait_erorr(exc, obj, f_get, nullptr, &args);
    }
}
...
py::object BTrait::wrapper_f_set(BTraitable* obj, const py::object& value) {
    try {
        ...
        throw trait_erorr(exc, obj, f_get, &value, nullptr);
    }
}
...
py::object BTrait::wrapper_f_set(BTraitable* obj, const py::object& value, const py::args& args) {
    try {
        ...
        throw trait_erorr(exc, obj, f_get, &value, &args);
    }
}
