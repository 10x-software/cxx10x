...
PYBIND11_MODULE(py10x_kernel, m)
{
    ...
    py::class_<BTrait>(m, "BTrait")
            ...
            .def_static("set_edge_deps_tracking",       &BTrait::set_edge_deps_tracking)
            .def_static("edge_deps_tracking",           &BTrait::edge_deps_tracking)
            ...
            .def("set_f_get_edt",               &BTrait::set_f_get_edt)
