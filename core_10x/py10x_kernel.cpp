...
//            ;
    ...
    py::class_<BDateCurve>(m, "BDateCurve")
            ...
            .def("value",                   py::overload_cast<const py::object&>(&BDateCurve::value, py::const_))
            .def("set_ip_kind",             &BDateCurve::set_ip_kind)
            .def("set_beginning_of_time",   py::overload_cast<const py::object&>(&BDateCurve::set_beginning_of_time))
