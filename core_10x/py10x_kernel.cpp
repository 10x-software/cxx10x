...
PYBIND11_MODULE(py10x_kernel, m)
{
    ...
    py::class_<PyLinkage>(m, "PyLinkage")
            ...
            .def_static("uuid7",                        &PyLinkage::uuid7)
            ;
    ...
    py::class_<BTraitFlags>(m, "BTraitFlags")
            ...
            .def_property_readonly_static("OFFGRAPH_SET",   [](const py::object&) { return BFlags(BTraitFlags::OFFGRAPH_SET); })
    ...
    py::class_<BTrait>(m, "BTrait")
            ...
            .def_static("set_use_instrumented_getters", &BTrait::set_use_instrumented_getters)
            .def_static("use_instrumented_getters",     &BTrait::use_instrumented_getters)
            ...
            .def("getter_has_args",             &BTrait::getter_has_args)
            .def("set_getter_has_args",         &BTrait::set_getter_has_args)
            ...
            .def("set_f_get_instrumented",      &BTrait::set_f_get_instrumented)
            .def("set_cxx_f_get",               &BTrait::set_cxx_f_get)
    ...
    py::class_<XCache>(m, "XCache")
            ...
            .def("perturb_existing_node",       &XCache::perturb_existing_node)
            .def("read_existing_node",          &XCache::read_existing_node)
//            .def(py::init<>())
...
//            ;
    ...
    py::class_<BTraitableClass>(m, "BTraitableClass")
            ...
            .def("is_default_cache",            &BTraitableClass::is_default_cache)
    ...
    py::class_<BTraitableProcessor>(m, "BTraitableProcessor")
            ...
            .def("default_cache",               &BTraitableProcessor::default_cache, py::return_value_policy::reference)
    ...
    py::class_<BFlags>(m, "BFlags")
            ...
            .def("__eq__",                      &BFlags::operator==)
            .def("__ne__",                      &BFlags::operator!=)
            .def("__hash__",                    [](const BFlags& f) { return py::hash(py::int_(f.value())); })
    ...
    py::class_<BDateCurve>(m, "BDateCurve")
            ...
            .def("set_dates",               &BDateCurve::set_dates)
            ...
            .def_property_readonly("beginning_of_time_as_date", &BDateCurve::beginning_of_time_as_date)
            .def_property_readonly("beginning_of_time",       &BDateCurve::beginning_of_time)
